...
SELECT UPPER(emp_name) AS name_upper FROM employees limit 5;

SELECT CONCAT(emp_name, ' --> ', department) AS emp_info FROM employees limit 5;

SELECT SUBSTRING(emp_name,1,4) AS short_name FROM employees limit 3;

SELECT TRIM(emp_name) AS clean_name FROM employees limit 5;

SELECT REPLACE(department, 'IT', 'Tech') AS new_department FROM employees limit 5;

SELECT LENGTH(emp_name) AS clean_name FROM employees LIMIT 5;

SELECT CHAR_LENGTH(emp_name) AS clean_name FROM employees LIMIT 3;

SELECT LEFT(emp_name,3) AS clean_name FROM employees LIMIT 5;

SELECT RIGHT(emp_name,3) AS clean_name FROM employees LIMIT 5;
